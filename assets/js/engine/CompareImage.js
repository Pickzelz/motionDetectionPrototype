;(function(App){
  ...
  App.CompareImage = function(){
    var sensitivity, temp1Canvas, temp2Canvas, temp1Context, temp2Context, topLeft, bottomRight, mimicCanvas, mimicCanvasContext, blendedData;
    function initialize(){
      sensitivity = 40;
      if(!temp1Canvas){
      ...
      if(!mimicCanvas){
        ...
        mimicCanvasContext = mimicCanvas.getContext("2d")
      }
    ...
    function compare(image1, image2, width, height){
      ...
      for(var y = 0; y < height; y++){
        for(var x = 0; x < width; x++){
          ...
          // console.log(pixel1Data)

          if(comparePixel(pixel1Data, pixel2Data) == false){
            setTopLeft(x,y);
            setBottomRight(x,y);

            var blendedData = new ImageData(1,1)
            mimicCanvasContext.putImageData(blendedData, x, y);
            // mimicCanvasContext.rect(x,y,1,1);
            // mimicCanvasContext.fill();
          }
        }
      }
      return {
